...
public abstract class AbstractTaintDetector implements Detector {
    ...
    public static TaintDataflow getTaintDataFlow(ClassContext classContext, Method method)
            throws CheckedAnalysisException {
    ...
    protected void logException(ClassContext classContext, Method method, Exception ex) {
